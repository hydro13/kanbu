...
describe('GitHub MCP Tool Schemas', () => {
  ...
  describe('LinkGitHubRepoSchema', () => {
    ...
    it('should reject missing required fields', () => {
      ...
      expect(LinkGitHubRepoSchema.safeParse({ ...validInput, owner: undefined }).success).toBe(
        false
      );
      expect(LinkGitHubRepoSchema.safeParse({ ...validInput, fullName: undefined }).success).toBe(
        false
      );
    });
  });
