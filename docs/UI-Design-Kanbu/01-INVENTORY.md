...
```css
--background: 0 0% 100% /* white */ --foreground: 222.2 84% 4.9% /* almost black */ --primary: 222.2
  47.4% 11.2% /* dark blue */ --secondary: 210 40% 96.1% /* light gray */ --destructive: 0 84.2%
  60.2% /* red */ --muted: 210 40% 96.1% /* light gray */ --accent: 210 40% 96.1% /* light gray */;
```

**Dark Mode:**

```css
--background: 222.2 84% 4.9% /* dark blue/black */ --foreground: 210 40% 98% /* almost white */
  --primary: 210 40% 98% /* almost white */ --secondary: 217.2 32.6% 17.5% /* dark gray */
