...
const TEST_CASES = [
  {
    ...
    existingFacts: [
      { id: 'edge-1', fact: '"Architecture" mentions concept "React"', validAt: '2024-01-01T00:00:00.000Z', invalidAt: null },
      { id: 'edge-2', fact: '"Architecture" mentions concept "TypeScript"', validAt: '2024-01-01T00:00:00.000Z', invalidAt: null },
    ],
  ...
  },
  {
    ...
    existingFacts: [
      { id: 'edge-1', fact: '"Team" mentions that "Jan" works at "Tech Inc"', validAt: '2024-01-01T00:00:00.000Z', invalidAt: null },
    ],
  ...
  },
  {
    ...
    existingFacts: [
      { id: 'edge-1', fact: '"History" mentions that "the project" used to use "MongoDB"', validAt: '2020-01-01T00:00:00.000Z', invalidAt: '2024-01-01T00:00:00.000Z' },
    ],
  ...
  },
  {
    ...
    existingFacts: [
      { id: 'edge-1', fact: '"Config" mentions that "the database host" is "localhost"', validAt: '2024-01-01T00:00:00.000Z', invalidAt: null },
      { id: 'edge-2', fact: '"Config" mentions that "the database port" is "5432"', validAt: '2024-01-01T00:00:00.000Z', invalidAt: null },
    ],
  ...
  },
  {
    ...
    existingFacts: [
      { id: 'edge-1', fact: '"Architecture" mentions that "the project" uses "MongoDB" as the primary database', validAt: '2023-01-01T00:00:00.000Z', invalidAt: null },
      { id: 'edge-2', fact: '"Architecture" mentions that "the project" uses "MySQL" as the primary database', validAt: '2022-01-01T00:00:00.000Z', invalidAt: null },
      { id: 'edge-3', fact: '"Architecture" mentions that "the project" uses "Redis" for caching', validAt: '2023-06-01T00:00:00.000Z', invalidAt: null },
    ],
  ...
  try {
    ...
    for (const testCase of TEST_CASES) {
      ...
      try {
        ...
        const correctContradictions = testCase.expectedContradictions.filter(id => actualSet.has(id))
        const missedContradictions = testCase.expectedContradictions.filter(id => !actualSet.has(id))
        ...
        console.log(`Correct:  ${correctContradictions.length}/${testCase.expectedContradictions.length}`)
    ...
    console.log('='.repeat(60))
    console.log(`Basic Detection Summary: ${passed} passed, ${failed} failed out of ${TEST_CASES.length}`)
    console.log('='.repeat(60))
    console.log('')
    ...
    const enhancedTestCases = [
      ...
      },
      {
        ...
        existingFacts: [
          { id: 'edge-1', fact: '"Config" mentions that "the theme" is "light"', validAt: '2024-01-01T00:00:00.000Z', invalidAt: null },
        ],
    ...
    for (const testCase of enhancedTestCases) {
      ...
      try {
        ...
        const meetsConfidence = result.contradictions.some(c => c.confidence >= testCase.expectedMinConfidence)
    ...
    console.log('='.repeat(60))
    console.log(`Enhanced Detection Summary: ${enhancedPassed} passed, ${enhancedFailed} failed out of ${enhancedTestCases.length}`)
    console.log('='.repeat(60))
    console.log('')
