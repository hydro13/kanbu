...
async function main() {
  ...
  try {
    ...
    const batchEdges: EdgeForEmbedding[] = [
      { id: 'perf-batch-1', fact: 'First test edge for batch performance', edgeType: 'MENTIONS', sourceNode: 'A', targetNode: 'B' },
      { id: 'perf-batch-2', fact: 'Second test edge for batch performance', edgeType: 'LINKS_TO', sourceNode: 'B', targetNode: 'C' },
      { id: 'perf-batch-3', fact: 'Third test edge for batch performance', edgeType: 'MENTIONS', sourceNode: 'C', targetNode: 'D' },
      { id: 'perf-batch-4', fact: 'Fourth test edge for batch performance', edgeType: 'LINKS_TO', sourceNode: 'D', targetNode: 'E' },
      { id: 'perf-batch-5', fact: 'Fifth test edge for batch performance', edgeType: 'MENTIONS', sourceNode: 'E', targetNode: 'F' },
    ]
    ...
    const vectorSize = typeof info.config.params.vectors === 'object' && 'size' in info.config.params.vectors 
