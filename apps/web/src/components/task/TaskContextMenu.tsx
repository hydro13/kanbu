    ...
    >
      {menuItems.map((item, index) =>
        item.divider ? (
          ...
          >
            <button className="w-full px-3 py-2 text-sm text-left hover:bg-accent flex items-center justify-between">
                ...
                {item.submenu.map((subitem, subindex) => (
                  <button
                    ...
                    className={cn(
                      ...
                      subitem.disabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-accent'
                    )}
