      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-500 dark:text-gray-400 text-sm">#{run.runNumber}</span>
          </div>
...
function WorkflowJobsList({
  ...
  const jobsQuery = trpc.github.getWorkflowJobs.useQuery({ workflowRunId }, { enabled: showJobs });
    ...
    <div>
      ...
      {showJobs && (
        <div className="mt-2 space-y-2">
          ...
          {jobsQuery.isError && <div className="text-sm text-red-500">Failed to load jobs</div>}
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-8 text-center">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">No workflow runs found</p>
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Workflow Runs</h3>
        <Button
          variant="ghost"
          size="sm"
          onClick={() => workflowRunsQuery.refetch()}
      ...
      <div className="space-y-2">
        {runs.map((run: WorkflowRun) => (
          <WorkflowRunItem
            ...
            isRerunning={
              rerunMutation.isPending && rerunMutation.variables?.workflowRunId === run.id
            }
            isCancelling={
              cancelMutation.isPending && cancelMutation.variables?.workflowRunId === run.id
            }
          />
        ))}
      </div>
