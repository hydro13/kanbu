...
function MetadataInfoPanel({ metadata }: { metadata: EmbedMetadata | undefined }) {
      ...
      {expanded && (
        <div className="lexical-embed-metadata-content">
          ...
          <div className="lexical-embed-metadata-header">
            ...
            <span className="lexical-embed-metadata-date">{formatDate(metadata.publishedAt)}</span>
            ...
            <div className="lexical-embed-metadata-timestamps">
              ...
              <ul>
                ...
                {timestamps.length > 15 && (
                  <li className="timestamp-more">+{timestamps.length - 15} more chapters</li>
                )}
              </ul>
            </div>
          )}
...
function EmbedComponent({
  ...
  return (
    ...
    >
      ...
      {provider === 'youtube' && <MetadataInfoPanel metadata={metadata} />}
      {provider !== 'youtube' && (
