...
function SearchModeToggle({ mode, onChange }: SearchModeToggleProps) {
  const modes: { value: SearchMode; label: string; icon: React.ReactNode; description: string }[] = [
    { value: 'hybrid', label: 'Hybrid', icon: <Zap className="h-3 w-3" />, description: 'Best of all (RRF)' },
    { value: 'local', label: 'Local', icon: <FileText className="h-3 w-3" />, description: 'Title match' },
    { value: 'keyword', label: 'Keyword', icon: <Type className="h-3 w-3" />, description: 'Full-text (BM25)' },
        ...
        <div className="px-4 pb-2">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-9 pr-8"
            />
            {(isSearching || semanticSearchMutation.isPending || hybridSearchMutation.isPending || keywordSearchMutation.isPending || rrfHybridSearchMutation.isPending) && (
