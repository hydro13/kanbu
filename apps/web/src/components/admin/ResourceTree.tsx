...
function TreeItem({
  ...
  return (
    ...
    >
      ...
      {suffix && (
        <span className="text-xs text-gray-400 dark:text-gray-500 font-mono">{suffix}</span>
      )}
    </div>
  );
}
...
export function ResourceTree({
  ...
  const toggleWorkspaceProjects = useCallback(
    (workspaceId: number) => {
      updateState((prev) => {
  ...
  const toggleProjectFeatures = useCallback(
    (projectId: number) => {
      updateState((prev) => {
  ...
  const isProjectsExpanded = (workspaceId: number) =>
    currentState.expandedWorkspaceProjects.has(workspaceId);
  const isFeaturesExpanded = (projectId: number) =>
    currentState.expandedProjectFeatures.has(projectId);
        ...
        <>
              ...
              <TreeItem
                ...
                icon={
                  <FolderIcon
                    className={cn(
                      'w-4 h-4',
                      isSectionExpanded('system') ? 'text-yellow-500' : 'text-yellow-600'
                    )}
                    open={isSectionExpanded('system')}
                  />
                }
                depth={1}
              ...
              {isSectionExpanded('system') && (
                <>
                  ...
                  <TreeItem
                    ...
                    icon={
                      featuresByScope.admin.length > 0 ? (
                        <FolderIcon
                          className={cn(
                            'w-4 h-4',
                            isSectionExpanded('admin') ? 'text-purple-400' : 'text-purple-500'
                          )}
                          open={isSectionExpanded('admin')}
                        />
                      ) : (
          ...
          <TreeItem
            ...
            icon={
              <FolderIcon
                className={cn(
                  'w-4 h-4',
                  isSectionExpanded('dashboard') ? 'text-yellow-500' : 'text-yellow-600'
                )}
                open={isSectionExpanded('dashboard')}
              />
            }
            depth={1}
          ...
          <TreeItem
            ...
            icon={
              <FolderIcon
                className={cn(
                  'w-4 h-4',
                  isSectionExpanded('profile') ? 'text-yellow-500' : 'text-yellow-600'
                )}
          ...
          <TreeItem
            ...
            icon={
              <FolderIcon
                className={cn(
                  'w-4 h-4',
                  isSectionExpanded('workspaces') ? 'text-yellow-500' : 'text-yellow-600'
                )}
                open={isSectionExpanded('workspaces')}
              />
            }
            depth={1}
                  ...
                  <TreeItem
                    ...
                    icon={
                      <FolderIcon
                        className={cn(
                          'w-4 h-4',
                          wsExpanded ? 'text-yellow-500' : 'text-yellow-600'
                        )}
                        open={wsExpanded}
                      />
                    }
                      ...
                      <TreeItem
                        ...
                        icon={
                          <FolderIcon
                            className={cn(
                              'w-4 h-4',
                              projectsExpanded ? 'text-yellow-500' : 'text-yellow-600'
                            )}
                                ...
                                icon={
                                  hasFeatures ? (
                                    <FolderIcon
                                      className={cn(
                                        'w-4 h-4',
                                        featuresExpanded ? 'text-green-400' : 'text-green-500'
                                      )}
                                  ...
                                  <TreeItem
                                    ...
                                    icon={
                                      <FolderIcon
                                        className={cn(
                                          'w-4 h-4',
                                          featuresExpanded ? 'text-yellow-500' : 'text-yellow-600'
                                        )}
                                        open={true}
                                      />
                                    }
                                    ...
                                    isExpandable={false}
                                    onClick={() => {
                                      /* Features folder is always expanded when project is */
                                    }}
                                  />
          ...
          <>
            <TreeItem
              ...
              icon={
                <FolderIcon
                  className={cn(
                    'w-4 h-4',
                    isSectionExpanded('groups') ? 'text-yellow-500' : 'text-yellow-600'
                  )}
                  open={isSectionExpanded('groups')}
                />
              }
              depth={1}
                  ...
                  <TreeItem
                    ...
                    icon={
                      <UserGroupIcon
                        className={cn(
                          'w-4 h-4',
                          isSystemGroup ? 'text-indigo-500' : 'text-teal-500'
                        )}
                      />
                    }
                    depth={2}
            ...
            {isSectionExpanded('groups') && groups.length === 0 && (
              <div
                className="text-sm text-gray-400 italic px-2 py-2"
