...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'AI Systems', path: '/admin/settings/ai', icon: CpuChipIcon, requiredScope: 'domainAdmin' },
  ...
  },
  {
    ...
    items: [
      { label: 'GitHub', path: '/admin/github', icon: GitHubIcon, requiredScope: 'workspaceAdmin', slug: 'github' },
    ],
  },
]
