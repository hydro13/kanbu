  ...
  return (
    <div className="flex flex-wrap items-center gap-1 mt-2 pt-2 border-t border-gray-100 dark:border-gray-700">
      ...
      {socialLinks.zoom && (
        <a
          href={
            socialLinks.zoom.startsWith('http')
              ? socialLinks.zoom
              : `https://zoom.us/j/${socialLinks.zoom}`
          }
          target="_blank"
          rel="noopener noreferrer"
          onClick={(e) => e.stopPropagation()}
      ...
      {socialLinks.googlemeet && (
        <a
          href={
            socialLinks.googlemeet.startsWith('http')
              ? socialLinks.googlemeet
              : `https://meet.google.com/${socialLinks.googlemeet}`
          }
          target="_blank"
          rel="noopener noreferrer"
          onClick={(e) => e.stopPropagation()}
      ...
      {socialLinks.teams && (
        <a
          href={
            socialLinks.teams.startsWith('http')
              ? socialLinks.teams
              : `https://teams.microsoft.com/l/meetup-join/${socialLinks.teams}`
          }
          target="_blank"
          rel="noopener noreferrer"
          onClick={(e) => e.stopPropagation()}
