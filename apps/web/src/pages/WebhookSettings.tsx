...
export function WebhookSettings() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = trpc.webhook.list.useQuery({ projectId: projectIdNum }, { enabled: projectIdNum > 0 });
      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-section-title text-foreground">Webhooks</h1>
          </div>
          <button
        ...
        <div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                  Webhooks send HTTP POST requests to your endpoints when events occur. Each request
          ...
          <div className="bg-card rounded-card border border-border overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
              <h2 className="text-lg font-semibold text-foreground">Configured Webhooks</h2>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-3 text-sm text-gray-500 dark:text-gray-400">
                          ...
                          <span>Events: {(webhook.events as string[]).length}</span>
                        </div>
                            ...
                            <div className="mt-2 flex items-center gap-2 bg-gray-100 dark:bg-gray-700 rounded-lg p-2 max-w-md">
                              {secrets[webhook.id] ? (
                                <>
                                  ...
                                  <button
                                    onClick={() =>
                                      handleCopy(secrets[webhook.id] ?? '', `secret-${webhook.id}`)
                                    }
                              ...
                              >
                                <RefreshCw
                                  className={`w-4 h-4 ${regenerateSecretMutation.isPending ? 'animate-spin' : ''}`}
                                />
                              </button>
                            </div>
                          )}
...
function WebhookDeliveries({ webhookId }: { webhookId: number }) {
  ...
  if (!deliveries || deliveries.length === 0) {
    return <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">No deliveries yet</div>;
  }
    ...
    <div className="mt-3 space-y-2">
      {deliveries.map((delivery) => (
        ...
        >
          ...
          <span className="text-gray-500 dark:text-gray-400">{delivery.statusCode || 'N/A'}</span>
