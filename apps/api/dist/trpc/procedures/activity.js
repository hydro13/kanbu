...
const listActivitiesSchema = zod_1.z.object({
    ...
    entityType: zod_1.z.enum(['task', 'subtask', 'comment', 'column', 'swimlane', 'project']).optional(),
    entityId: zod_1.z.number().optional(),
    eventType: zod_1.z.string().optional(),
    limit: zod_1.z.number().min(1).max(100).default(50),
    offset: zod_1.z.number().min(0).default(0),
});
const taskActivitiesSchema = zod_1.z.object({
    taskId: zod_1.z.number(),
    limit: zod_1.z.number().min(1).max(100).default(50),
    offset: zod_1.z.number().min(0).default(0),
});
const recentActivitiesSchema = zod_1.z.object({
    projectId: zod_1.z.number(),
...
// Activity Router
// =============================================================================
exports.activityRouter = (0, router_1.router)({
    /**
     ...
     */
    forTask: router_1.protectedProcedure
     ...
     * Requires at least VIEWER access
     */
    getRecent: router_1.protectedProcedure
     ...
     * Requires at least VIEWER access
     */
    getStats: router_1.protectedProcedure
