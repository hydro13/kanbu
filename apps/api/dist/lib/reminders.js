...
exports.REMINDER_PRESETS = void 0;
exports.getDueDateStatus = getDueDateStatus;
exports.formatDueDateRelative = formatDueDateRelative;
exports.calculateReminderTime = calculateReminderTime;
exports.getReminderPreset = getReminderPreset;
exports.formatReminderRelative = formatReminderRelative;
exports.getQuickDateOptions = getQuickDateOptions;
exports.isQuickDateOption = isQuickDateOption;
exports.toUTC = toUTC;
 ...
 */
function getDueDateStatus(dateDue) {
    if (!dateDue) {
        return null;
    }
    const now = new Date();
 ...
 */
function formatDueDateRelative(dateDue) {
 ...
 */
function calculateReminderTime(dateDue, preset) {
    if (preset === 'none' || preset === 'custom') {
        return null;
    }
    const presetConfig = exports.REMINDER_PRESETS.find((p) => p.preset === preset);
    if (!presetConfig) {
        return null;
    }
 ...
 */
function getReminderPreset(dateDue, reminderAt) {
    const diffMs = dateDue.getTime() - reminderAt.getTime();
    // Find closest matching preset (with 5% tolerance)
    for (const preset of exports.REMINDER_PRESETS) {
        if (preset.offsetMs === 0)
            continue;
 ...
 */
function formatReminderRelative(dateDue, reminderAt) {
    if (!dateDue) {
 ...
 */
function isQuickDateOption(date) {
