...
export const assistantRouter = router({
   ...
   */
  revokeBinding: protectedProcedure.input(revokeBindingSchema).mutation(async ({ ctx, input }) => {
   ...
   */
  validateToken: publicProcedure.input(validateTokenSchema).query(async ({ ctx, input }) => {
