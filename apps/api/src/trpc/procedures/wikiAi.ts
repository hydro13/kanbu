 ...
 * Version: 1.0.0
 *
 * tRPC procedures for Wiki AI features (Fase 15.1).
 * Provides access to embeddings, entity extraction, and text operations
 * for Wiki pages using configured AI providers.
 *
