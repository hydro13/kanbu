...
export const tagRouter = router({
   ...
   * Requires at least VIEWER access
   */
  get: protectedProcedure.input(tagIdSchema).query(async ({ ctx, input }) => {
   ...
   * Requires at least MEMBER access
   */
  addToTask: protectedProcedure.input(addTagToTaskSchema).mutation(async ({ ctx, input }) => {
   ...
   * Requires at least VIEWER access
   */
  getTaskTags: protectedProcedure.input(getTaskTagsSchema).query(async ({ ctx, input }) => {
