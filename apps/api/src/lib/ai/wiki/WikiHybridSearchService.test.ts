...
const mockBm25Results: Bm25SearchResult[] = [
  {
    ...
    slug: 'kanban-guide',
    rank: 0.8,
    headline: '<mark>Kanban</mark> intro',
    source: 'workspace',
  },
  {
    pageId: 2,
...
const mockEdgeResults: EdgeSearchResult[] = [
  {
    ...
    pageId: 1,
    score: 0.75,
    fact: 'Kanban is a visual method',
    edgeType: 'DESCRIBES',
    sourceNodeId: 'n1',
    targetNodeId: 'n2',
  },
  {
    ...
    pageId: 5,
    score: 0.65,
    fact: 'Sprint planning involves team',
    edgeType: 'RELATES_TO',
    sourceNodeId: 'n3',
    targetNodeId: 'n4',
  },
...
describe('WikiHybridSearchService', () => {
  ...
  beforeEach(() => {
    ...
    service = new WikiHybridSearchService(mockBm25 as any, mockEmbedding as any, mockEdge as any);
  });
  ...
  describe('rrfFusion', () => {
    it('should calculate correct RRF scores for single source', () => {
      const results = service.rrfFusion(mockBm25Results, [], [], {
        rrfK: 60,
        bm25Weight: 1.0,
        vectorWeight: 1.0,
        edgeWeight: 0.5,
    ...
    it('should boost documents appearing in multiple sources', () => {
      const results = service.rrfFusion(mockBm25Results, mockVectorResults, [], {
        rrfK: 60,
        bm25Weight: 1.0,
        vectorWeight: 1.0,
        edgeWeight: 0.5,
    ...
    it('should respect weights', () => {
      ...
      const highBm25 = service.rrfFusion(mockBm25Results, mockVectorResults, [], {
        rrfK: 60,
        bm25Weight: 2.0,
        vectorWeight: 0.5,
        edgeWeight: 0.5,
      ...
      const highVector = service.rrfFusion(mockBm25Results, mockVectorResults, [], {
        rrfK: 60,
        bm25Weight: 0.5,
        vectorWeight: 2.0,
        edgeWeight: 0.5,
    ...
    it('should handle edge results correctly', () => {
      const results = service.rrfFusion([], [], mockEdgeResults, {
        rrfK: 60,
        bm25Weight: 1.0,
        vectorWeight: 1.0,
        edgeWeight: 1.0,
    ...
    it('should respect limit parameter', () => {
      const results = service.rrfFusion(mockBm25Results, mockVectorResults, mockEdgeResults, {
        rrfK: 60,
        bm25Weight: 1.0,
        vectorWeight: 1.0,
        edgeWeight: 0.5,
