...
describe('WikiBm25Service', () => {
      ...
      mockPrisma.$queryRawUnsafe.mockResolvedValue([
        {
          ...
          slug: 'kanban-guide',
          rank: 0.5,
          headline: 'Test <mark>kanban</mark>',
        },
        {
          id: 2,
          title: 'Kanban Tips',
          slug: 'kanban-tips',
          rank: 0.3,
          headline: 'More <mark>kanban</mark>',
        },
      ]);
  ...
  describe('getSuggestions', () => {
    ...
    it('should return suggestions for valid prefix', async () => {
      mockPrisma.$queryRaw.mockResolvedValue([{ word: 'kanban' }, { word: 'kanbu' }]);
    ...
    it('should filter out single character words', async () => {
      mockPrisma.$queryRaw.mockResolvedValue([{ word: 'a' }, { word: 'kanban' }]);
