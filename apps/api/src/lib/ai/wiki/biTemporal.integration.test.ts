...
describe('bi-temporal integration', () => {
  ...
  describe('complete bi-temporal lifecycle', () => {
    it('should handle fact evolution over time', () => {
      const timeline: Array<{
        time: string
        action: string
        edges: Array<{ id: string; fact: string; validAt: string | null; invalidAt: string | null }>
      }> = []
      ...
      timeline.push({
        ...
        action: 'create',
        edges: [
          { id: 'e1', fact: 'Jan is a junior developer', validAt: '2024-01-01T00:00:00.000Z', invalidAt: null },
        ],
      })
      ...
      timeline.push({
        ...
        action: 'update',
        edges: [
          { id: 'e1', fact: 'Jan is a junior developer', validAt: '2024-01-01T00:00:00.000Z', invalidAt: '2025-01-01T00:00:00.000Z' },
          { id: 'e2', fact: 'Jan is a senior developer', validAt: '2025-01-01T00:00:00.000Z', invalidAt: null },
        ],
      })
      ...
      timeline.push({
        ...
        edges: [
          { id: 'e1', fact: 'Jan is a junior developer', validAt: '2024-01-01T00:00:00.000Z', invalidAt: '2025-01-01T00:00:00.000Z' },
          { id: 'e2', fact: 'Jan is a senior developer', validAt: '2025-01-01T00:00:00.000Z', invalidAt: '2026-01-01T00:00:00.000Z' },
          { id: 'e3', fact: 'Jan is a tech lead', validAt: '2026-01-01T00:00:00.000Z', invalidAt: null },
        ],
      })
    ...
    it('should support "as of" queries at any point in time', () => {
      ...
      const edges = [
        { id: 'e1', fact: 'Project uses MySQL', validAt: '2020-01-01T00:00:00.000Z', invalidAt: '2022-01-01T00:00:00.000Z' },
        { id: 'e2', fact: 'Project uses PostgreSQL', validAt: '2022-01-01T00:00:00.000Z', invalidAt: '2025-01-01T00:00:00.000Z' },
        { id: 'e3', fact: 'Project uses MongoDB', validAt: '2025-01-01T00:00:00.000Z', invalidAt: null },
      ]
  ...
  describe('edge cases', () => {
    ...
    it('should handle same-day fact changes', () => {
      const edges = [
        { id: 'e1', fact: 'Status: Draft', validAt: '2026-01-13T09:00:00.000Z', invalidAt: '2026-01-13T14:00:00.000Z' },
        { id: 'e2', fact: 'Status: Published', validAt: '2026-01-13T14:00:00.000Z', invalidAt: null },
      ]
    ...
    it('should handle overlapping temporal boundaries', () => {
      ...
      const edges = [
        { id: 'e1', fact: 'Version 1.0', validAt: '2026-01-01T00:00:00.000Z', invalidAt: '2026-01-15T00:00:00.000Z' },
