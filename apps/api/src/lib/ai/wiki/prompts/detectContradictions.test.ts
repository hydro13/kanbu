  ...
  describe('getDetectContradictionsUserPrompt', () => {
    it('should format context with existing facts', () => {
      const existingFacts: ExistingFact[] = [
        { id: 'edge-1', fact: 'Jan works at Acme', validAt: '2024-01-01T00:00:00.000Z', invalidAt: null },
...
describe('enhancedDetectContradictions (Fase 17.2)', () => {
  ...
  describe('toBasicContradictionResult', () => {
    it('should convert enhanced result to basic result', () => {
      const enhanced = {
        contradictions: [
          { factId: 'edge-1', confidence: 0.95, category: ContradictionCategory.FACTUAL, conflictDescription: 'Test 1' },
          { factId: 'edge-2', confidence: 0.85, category: ContradictionCategory.SEMANTIC, conflictDescription: 'Test 2' },
        ],
...
describe('batchDetectContradictions (Fase 17.2)', () => {
  ...
  describe('getBatchDetectContradictionsUserPrompt', () => {
    it('should format multiple new facts', () => {
      ...
      const existingFacts: ExistingFact[] = [
        { id: 'edge-1', fact: 'Jan works at TechCorp', validAt: '2024-01-01T00:00:00.000Z', invalidAt: null },
      ]
...
describe('categoryHandling (Fase 17.2)', () => {
  describe('DEFAULT_CATEGORY_HANDLING', () => {
    ...
    it('should auto-invalidate FACTUAL contradictions', () => {
      expect(DEFAULT_CATEGORY_HANDLING[ContradictionCategory.FACTUAL].action)
        .toBe(ResolutionAction.AUTO_INVALIDATE)
    })

    it('should require confirmation for TEMPORAL contradictions', () => {
      expect(DEFAULT_CATEGORY_HANDLING[ContradictionCategory.TEMPORAL].action)
        .toBe(ResolutionAction.REQUIRE_CONFIRMATION)
    })
  })
  ...
  describe('filterContradictionsByCategory', () => {
    it('should separate contradictions by action type', () => {
      const contradictions: ContradictionDetail[] = [
        { factId: 'edge-1', confidence: 0.95, category: ContradictionCategory.FACTUAL, conflictDescription: 'High FACTUAL' },
        { factId: 'edge-2', confidence: 0.75, category: ContradictionCategory.FACTUAL, conflictDescription: 'Low FACTUAL' },
        { factId: 'edge-3', confidence: 0.9, category: ContradictionCategory.TEMPORAL, conflictDescription: 'TEMPORAL' },
        { factId: 'edge-4', confidence: 0.8, category: ContradictionCategory.ATTRIBUTE, conflictDescription: 'ATTRIBUTE' },
      ]
