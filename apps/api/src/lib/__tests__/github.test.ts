...
describe('Cascade Delete Logic', () => {
  describe('workspace deletion', () => {
    it('should cascade delete installations', () => {
      ...
      const remainingInstallations = installations.filter((i) => i.workspaceId !== workspace.id);
    ...
    it('should cascade delete user mappings', () => {
      ...
      const remainingMappings = mappings.filter((m) => m.workspaceId !== workspace.id);
  ...
  describe('project deletion', () => {
    it('should cascade delete repository', () => {
      ...
      const remainingRepos = repositories.filter((r) => r.projectId !== project.id);
  ...
  describe('task deletion', () => {
    it('should set taskId to null on related GitHub records (SetNull)', () => {
      ...
      const updatedIssues = issues.map((i) => (i.taskId === task.id ? { ...i, taskId: null } : i));
      const updatedPRs = prs.map((p) => (p.taskId === task.id ? { ...p, taskId: null } : p));
